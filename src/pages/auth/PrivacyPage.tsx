    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <section>
          ...
          <p>
            위 서비스는 단순 기술적 처리 목적이며 개인정보를 판매하거나
            제3자에게 제공하지 않습니다.
          </p>
        ...
        <section>
          ...
          <h2>5. 참여자의 권리 및 내부 열람 제한</h2>

          <ul>
            <li>참여자는 언제든지 열람, 수정, 삭제를 요청할 수 있습니다.</li>
            <li>
              참여자의 발화 기록 및 개인 분석 데이터는 앱 기능 작동을 위해
              데이터베이스에 임시 저장되지만 운영팀원이 이를 임의로 열람하지 않습니다.
            </li>
            <li>
              데이터 접근 권한은 최소한으로 제한되며 연구 목적 범위 내에서만 사용됩니다.
            </li>
          </ul>
